...
const Projects = () => {
  ...
  return (
    <Fragment>
      ...
      <div className="web_tm_section" id="portfolio">
        <div className="web_tm_portfolio">
              ...
              >
                <SwiperSlide>
                  <div className="list_inner">
                    ...
                    <a
                      className="web_tm_full_link popup-youtube"
                ...
                <SwiperSlide>
                  <div className="list_inner">
                    ...
                    <a
                      className="web_tm_full_link popup-vimeo"
                ...
                <SwiperSlide>
                  <div className="list_inner">
                    ...
                    <a
                      className="web_tm_full_link soundcloude_link mfp-iframe audio"
                ...
                <SwiperSlide>
                  <div className="list_inner">
                    ...
                    <a
                      className="web_tm_full_link details_link c-pointer"
                ...
                <SwiperSlide>
                  <div className="list_inner">
                    ...
                    <a
                      className="web_tm_full_link zoom"
